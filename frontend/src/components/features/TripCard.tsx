...
const TripCard: React.FC<TripCardProps> = ({ trip, isFavorite = false }) => {
  ...
  const handleToggleFavorite = (e: React.MouseEvent) => {
    e.preventDefault();
    console.log('Toggle favorite for trip:', trip.id);
  ...
  return (
    <Card hover className="overflow-hidden group">
      <div className="relative">
        <img
          src={trip.images[0] || 'https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg?auto=compress&cs=tinysrgb&w=500&h=300&fit=crop'}
          alt={trip.title}
      ...
      <div className="p-4">
        ...
        <div className="mt-3 pt-3 border-t border-gray-200">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center space-x-2">
              <img
                src={trip.provider.logo || 'https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg?auto=compress&cs=tinysrgb&w=30&h=30&fit=crop'}
