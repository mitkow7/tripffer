...
const TripDetailsPage: React.FC = () => {
  ...
  const handleToggleFavorite = () => {
    console.log('Toggle favorite for trip:', id);
    // Replace with your actual API call
  };

  const handleBooking = async () => {
    console.log('Create booking for trip:', id, { travelers, specialRequests });
    // Replace with your actual API call
          ...
          <div className="lg:col-span-2">
            ...
            <Card className="mb-8 overflow-hidden">
              <div className="relative">
                <img
                  src={trip.images[currentImageIndex] || 'https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&fit=crop'}
                  alt={trip.title}
            ...
            <Card className="p-6 mb-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">{trip.description}</p>
              ...
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Travel Provider</h3>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <img
                      src={trip.provider.logo || 'https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg?auto=compress&cs=tinysrgb&w=60&h=60&fit=crop'}
                      alt={trip.provider.name}
                      className="w-12 h-12 rounded-full object-cover"
                    />
                    <div>
                      <h4 className="font-semibold text-gray-900">{trip.provider.name}</h4>
                      <div className="flex items-center">
                        <Star className="w-4 h-4 text-yellow-500 fill-current mr-1" />
                        <span className="text-sm text-gray-600">{trip.provider.rating} provider rating</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
                ...
                {!showBookingForm ? (
                  <div className="space-y-4">
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-600">Subtotal ({travelers} travelers)</span>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-600">Total for {travelers} travelers</span>
              ...
              <Card className="p-6 mt-6">
                <h3 className="font-semibold text-gray-900 mb-4">Why Book with Tripffer?</h3>
