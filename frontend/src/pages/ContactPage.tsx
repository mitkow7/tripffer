        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              We're here to help you plan the perfect trip. Reach out to our team of travel experts 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Monday - Friday: 6AM - 10PM EST</div>
                    <div className="text-gray-600">Saturday - Sunday: 8AM - 8PM EST</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
            ...
            {/* Quick Stats */}
            <Card className="p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Why Choose Our Support</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">Expert Travel Advisors</div>
                    <div className="text-sm text-gray-600">Trained professionals with travel expertise</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Available in 12 languages</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">98% Satisfaction Rate</div>
